    ...
    <section className="py-12 md:py-16 lg:py-20 bg-[#FFF8EE]">
      <div className="container mx-auto max-w-[1120px] px-4 sm:px-6">
        <div className="text-center max-w-3xl mx-auto mb-10 md:mb-12">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-foreground mb-5 md:mb-6 animate-slide-up">
            Esqueceu de pagar o <span className="text-primary">DAS</span> de novo?
          </h1>

          <p className="text-base sm:text-lg text-muted-foreground mb-6 md:mb-8 animate-slide-up delay-200">
