    ...
    <section id="pricing" className="py-12 md:py-16 lg:py-20 bg-white">
      <div className="container mx-auto max-w-[1120px] px-4 sm:px-6">
        <div className="text-center max-w-3xl mx-auto mb-6 md:mb-8 animate-fade-in">
          ...
          <p className="mt-3 md:mt-4 text-base sm:text-lg text-gray-700">Apenas para os primeiros 100 assinantes</p>
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden hover:shadow-xl transition-shadow duration-300">
            <div className="p-6 md:p-8">
              <div className="flex justify-between items-start mb-2">
                <h3 className="text-xl md:text-2xl font-bold text-gray-900">Plano Anual</h3>
              ...
              <div className="mt-3 md:mt-4 flex flex-col">
                ...
                <div className="flex items-baseline mt-1">
                  <span className="text-3xl md:text-4xl font-extrabold text-gray-900">R$ 47,90</span>
            ...
            <div className="bg-gray-50 p-4 md:p-6">
              <Link href="/checkout">
                <Button className="w-full py-4 md:py-6 text-sm md:text-base font-medium rounded-[8px] hover:scale-105 transition-transform">
                  ASSINAR AGORA
                </Button>
              </Link>
            </div>
